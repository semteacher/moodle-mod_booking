...
Feature: Create recurring options as teacher and configuring it.
  ...
  Scenario: Booking: add few recurring options as a teacher and verify as student
    ...
    And I should see "15 April 2045, 3:20 PM" in the ".allbookingoptionstable_r2" "css_element"
    And I should see "9 August 2045" in the ".allbookingoptionstable_r2" "css_element"
    And I should see "Only users who have previously booked" in the ".allbookingoptionstable_r2 .booking-button-area" "css_element"
    And I should see "RecurrOpt" in the ".allbookingoptionstable_r2 .booking-button-area" "css_element"
    And I should see "are allowed to book." in the ".allbookingoptionstable_r2 .booking-button-area" "css_element"
    And I should see "RecurrOpt" in the ".allbookingoptionstable_r3" "css_element"
    And I should see "15 May 2045, 3:20 PM" in the ".allbookingoptionstable_r3" "css_element"
    And I should see "9 September 2045" in the ".allbookingoptionstable_r3" "css_element"
    And I should see "Only users who have previously booked" in the ".allbookingoptionstable_r3 .booking-button-area" "css_element"
    And I should see "RecurrOpt" in the ".allbookingoptionstable_r3 .booking-button-area" "css_element"
    And I should see "are allowed to book." in the ".allbookingoptionstable_r3 .booking-button-area" "css_element"
    And I should see "RecurrOpt" in the ".allbookingoptionstable_r5" "css_element"
    And I should see "22 March 2045, 3:20 PM" in the ".allbookingoptionstable_r5" "css_element"
    And I should see "16 July 2045" in the ".allbookingoptionstable_r5" "css_element"
    And I should not see "Only users who have previously booked" in the ".allbookingoptionstable_r5 .booking-button-area" "css_element"
    And I should not see "RecurrOpt" in the ".allbookingoptionstable_r5 .booking-button-area" "css_element"
    And I should not see "are allowed to book." in the ".allbookingoptionstable_r5 .booking-button-area" "css_element"
    And I should see "RecurrOpt" in the ".allbookingoptionstable_r6" "css_element"
    And I should see "29 March 2045, 3:20 PM" in the ".allbookingoptionstable_r6" "css_element"
    And I should see "23 July 2045" in the ".allbookingoptionstable_r6" "css_element"
    And I should not see "Only users who have previously booked" in the ".allbookingoptionstable_r6 .booking-button-area" "css_element"
    And I should not see "RecurrOpt" in the ".allbookingoptionstable_r6 .booking-button-area" "css_element"
    And I should not see "are allowed to book." in the ".allbookingoptionstable_r6 .booking-button-area" "css_element"
