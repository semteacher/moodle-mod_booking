...
Feature: In a booking - create options and filter it
  ...
  Background:
    ...
    And the following "mod_booking > options" exist:
      | booking    | text              | titleprefix | course | description  | teachersforoption | optiondateid_0 | daystonotify_0 | coursestarttime_0 | courseendtime_0 |
      | My booking | Option - Teacher1 | 4           | C1     | Option deskr | teacher1          | 0              | 0              | 2346937200        | 2347110000      |
      | My booking | Option - Teacher2 | 5           | C1     | Option deskr | teacher2          | 0              | 0              | 2347110000        | 2347282800      |
      | My booking | Option - Teacher3 | 6           | C1     | Option deskr | teacher3,teacher1 | 0              | 0              | 2347369200        | 2347542000      |
